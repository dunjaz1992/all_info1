...
class Song(models.Model):
    ...
    author = models.ForeignKey(Musicion, on_delete=models.CASCADE, related_name='songs')
    feat = models.ForeignKey(Musicion, on_delete=models.SET_NULL, null=True, related_name='feats', blank=True)
